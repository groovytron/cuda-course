...
RayTracing::RayTracing(uint w, uint h, float dt, uint n, const DomaineMath& domaineMath) :
	Animable_I<float>(w, h, "Raytracing_OMP",domaineMath), variateurAnimation(Interval<float>(0, 2 * PI), dt)
    {
    // Input
    this->n = n;
 ...
 */
void RayTracing::processForAutoOMP(float* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    RayTracingMath damierMath(n); // ici pour preparer cuda
 ...
 */
void RayTracing::processEntrelacementOMP(float* ptrTabPixels, uint w, uint h, const DomaineMath& domaineMath)
    {
    RayTracingMath damierMath(n); // ici pour preparer cuda
 ...
 * 	- forAutoOMP
 */
void RayTracing::workPixel(float* ptrColorIJ,int i, int j,const DomaineMath& domaineMath,RayTracingMath* ptrDamierMath)
    {
