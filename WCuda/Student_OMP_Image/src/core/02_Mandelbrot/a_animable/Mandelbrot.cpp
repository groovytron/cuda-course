...
Mandelbrot::Mandelbrot(uint w, uint h, float n, const DomaineMath& domaineMath) :
	Animable_I<uchar4>(w, h, "Mandelbrot_OMP_rgba_uchar4", domaineMath), variateurAnimation(Interval<float>(20, n), 1)
    {
    // Input
